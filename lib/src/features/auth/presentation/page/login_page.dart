...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _loadSavedCredentials() async {
    ...
    setState(() {
      ...
      uidController.text = prefs.getString('identifier') ?? '';
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: isActive ? Border.all(color: AppColors.grey, width: 2) : null,
          ),
          child: Text(
            text,
            style: TextStyle(
  ...
  Widget _buildUidField(BuildContext context) {
    ...
    return CustomTextFormField(
      ...
      hint: isEmailSelected ? "example@email.com" : "98XXXXXXXX",
      controller: uidController,
      keyboardType: isEmailSelected
          ? TextInputType.emailAddress
          : TextInputType.phone,
      maxLength: isEmailSelected ? null : 10,
      prefix: isEmailSelected
          ? null
          : Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 8), // SPACE before phone number
          ],
        ),
      ),
      validator: (value) {
